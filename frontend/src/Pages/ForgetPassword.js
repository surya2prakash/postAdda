...
export default function ForgetPassword() {
   ...
   async function emailSubmitHandler(event){
       ...
       try{
        const res = await axios.post("http://localhost:5000/api/v1/forgetPassword",dataEmail,{
   ...
   async function otpSubmitHanler(event){
          ...
          try{
               const res = await axios.post("http://localhost:5000/api/v1/verifyOtp",otpData,{
                      withCredentials: true
   ...
   async function passwordSubmithandler(event){
         ...
         try{
            const res = await axios.post("http://localhost:5000/api/v1/setPassword",passwordData,{
                 withCredentials: true
